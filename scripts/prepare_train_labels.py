    ...
    for _, annotations in annotations_per_image.items():
        ...
        for annotation in annotations[0]:
            ...
            prepared_annotation = {
                ...
                # 'scale_provided': (annotation['bbox'][3] + 1)/ net_input_size,
                'num_keypoints': annotation['num_keypoints'],
                'segmentations': annotations[1]
            }
            
            # print('scale_provided:',prepared_annotation['scale_provided'])
            ...
            for other_annotation in annotations[0]:
                ...
                prepared_other_annotation = {
                    ...
                    # 'scale_provided': (other_annotation['bbox'][3] + 1)/ net_input_size,
