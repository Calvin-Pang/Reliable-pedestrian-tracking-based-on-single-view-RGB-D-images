...
from models.with_mobilenet_V5 import PoseEstimationWithMobileNet
...
def train(prepared_train_labels, train_images_folder, num_refinement_stages, base_lr, batch_size, batches_per_iter,
    ...
    optimizer = optim.Adam([
        ...
        # {'params': get_parameters_conv(net.rgb_depth_0, 'weight'), 'lr': base_lr},
        # {'params': get_parameters_conv(net.rgb_depth_0, 'bias'), 'lr': base_lr * 2, 'weight_decay': 0},
        # {'params': get_parameters_conv_depthwise(net.rgb_depth_0, 'weight'), 'weight_decay': 0},
        # {'params': get_parameters_conv(net.rgb_rgbd_0, 'weight'), 'lr': base_lr},
        # {'params': get_parameters_conv(net.rgb_rgbd_0, 'bias'), 'lr': base_lr * 2, 'weight_decay': 0},
        # {'params': get_parameters_conv_depthwise(net.rgb_rgbd_0, 'weight'), 'weight_decay': 0},
        # {'params': get_parameters_conv(net.depth_rgbd_0, 'weight'), 'lr': base_lr},
        # {'params': get_parameters_conv(net.depth_rgbd_0, 'bias'), 'lr': base_lr * 2, 'weight_decay': 0},
        # {'params': get_parameters_conv_depthwise(net.depth_rgbd_0, 'weight'), 'weight_decay': 0},
        # {'params': get_parameters_conv(net.rgb_depth_1, 'weight'), 'lr': base_lr},
        # {'params': get_parameters_conv(net.rgb_depth_1, 'bias'), 'lr': base_lr * 2, 'weight_decay': 0},
        # {'params': get_parameters_conv_depthwise(net.rgb_depth_1, 'weight'), 'weight_decay': 0},
        # {'params': get_parameters_conv(net.rgb_rgbd_1, 'weight'), 'lr': base_lr},
        # {'params': get_parameters_conv(net.rgb_rgbd_1, 'bias'), 'lr': base_lr * 2, 'weight_decay': 0},
        # {'params': get_parameters_conv_depthwise(net.rgb_rgbd_1, 'weight'), 'weight_decay': 0},
        # {'params': get_parameters_conv(net.depth_rgbd_1, 'weight'), 'lr': base_lr},
        # {'params': get_parameters_conv(net.depth_rgbd_1, 'bias'), 'lr': base_lr * 2, 'weight_decay': 0},
        # {'params': get_parameters_conv_depthwise(net.depth_rgbd_1, 'weight'), 'weight_decay': 0},
        # {'params': get_parameters_conv(net.rgb_depth_2, 'weight'), 'lr': base_lr},
        # {'params': get_parameters_conv(net.rgb_depth_2, 'bias'), 'lr': base_lr * 2, 'weight_decay': 0},
        # {'params': get_parameters_conv_depthwise(net.rgb_depth_2, 'weight'), 'weight_decay': 0},
        # {'params': get_parameters_conv(net.rgb_rgbd_2, 'weight'), 'lr': base_lr},
        # {'params': get_parameters_conv(net.rgb_rgbd_2, 'bias'), 'lr': base_lr * 2, 'weight_decay': 0},
        # {'params': get_parameters_conv_depthwise(net.rgb_rgbd_2, 'weight'), 'weight_decay': 0},
        # {'params': get_parameters_conv(net.depth_rgbd_2, 'weight'), 'lr': base_lr},
        # {'params': get_parameters_conv(net.depth_rgbd_2, 'bias'), 'lr': base_lr * 2, 'weight_decay': 0},
        # {'params': get_parameters_conv_depthwise(net.depth_rgbd_2, 'weight'), 'weight_decay': 0},
        ...
        {'params': get_parameters_conv(net.cpm_rgbd, 'weight'), 'lr': base_lr},
        {'params': get_parameters_conv(net.cpm_rgbd, 'bias'), 'lr': base_lr * 2, 'weight_decay': 0},
        {'params': get_parameters_conv_depthwise(net.cpm_rgbd, 'weight'), 'weight_decay': 0},
        {'params': get_parameters_conv(net.rgb_rgbd, 'weight'), 'lr': base_lr},
        {'params': get_parameters_conv(net.rgb_rgbd, 'bias'), 'lr': base_lr * 2, 'weight_decay': 0},
        {'params': get_parameters_conv_depthwise(net.rgb_rgbd, 'weight'), 'weight_decay': 0},
