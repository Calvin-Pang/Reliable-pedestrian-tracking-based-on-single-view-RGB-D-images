...
from models.with_mobilenet_V4x import PoseEstimationWithMobileNet
...
def train(prepared_train_labels, train_images_folder, num_refinement_stages, base_lr, batch_size, batches_per_iter,
    ...
    optimizer = optim.Adam([
        ...
        {'params': get_parameters_conv(net.rgb_rgbd_3, 'weight'), 'lr': base_lr},
        {'params': get_parameters_conv(net.rgb_rgbd_3, 'bias'), 'lr': base_lr * 2, 'weight_decay': 0},
        {'params': get_parameters_conv_depthwise(net.rgb_rgbd_3, 'weight'), 'weight_decay': 0},
        {'params': get_parameters_conv(net.rgb_rgbd_4, 'weight'), 'lr': base_lr},
        {'params': get_parameters_conv(net.rgb_rgbd_4, 'bias'), 'lr': base_lr * 2, 'weight_decay': 0},
        {'params': get_parameters_conv_depthwise(net.rgb_rgbd_4, 'weight'), 'weight_decay': 0},
        {'params': get_parameters_conv(net.cpm_fusion, 'weight'), 'lr': base_lr},
        {'params': get_parameters_conv(net.cpm_fusion, 'bias'), 'lr': base_lr * 2, 'weight_decay': 0},
        {'params': get_parameters_conv_depthwise(net.cpm_fusion, 'weight'), 'weight_decay': 0},
