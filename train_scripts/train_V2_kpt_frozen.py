...
from models.with_mobilenet_V2_frozen_kpt import PoseEstimationWithMobileNet
...
def train(prepared_train_labels, train_images_folder, num_refinement_stages, base_lr, batch_size, batches_per_iter,
    ...
    # print('number of frozen layers:',276)
    # summaryWriter = SummaryWriter("./runs/exp1")
    for epochId in range(current_epoch, 300):
        # print('iter done:',num_iter,'epochID done:',epochId)
        scheduler.step()
