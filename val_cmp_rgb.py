                ...
                if converted_pos[1] != '1':
                    ...
                    for n in range(len(BODY_PARTS_KPT_IDS) - 2):
                        ...
                        if converted_pos[start_id] != '0' and converted_pos[end_id] != '0':
                            ...
                            cv2.line(img, (int(x_a), int(y_a)), (int(x_b), int(y_b)), (int(color_list[n][0]), int(color_list[n][1]), int(color_list[n][2])), 1, lineType = cv2.LINE_AA)
...
if __name__ == '__main__':
    ...
    net = PoseEstimationWithMobileNet(num_img_input=args.num_img_input,num_refinement_stages = args.num_refinement_stages)
    # print(type(net))
